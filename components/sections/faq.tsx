      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl xl:text-5xl font-bold mb-4">Preguntas frecuentes</h2>
            <p className="text-lg text-muted-foreground">Respuestas a las dudas más comunes sobre Intuitive ERP</p>
          </div>
          ...
          <Card className="mt-10 p-6 glass border-border/50 text-center">
            <h3 className="font-semibold text-lg mb-2">¿No encuentras respuesta a tu pregunta?</h3>
            <p className="text-muted-foreground mb-4">Escríbenos directamente y te ayudamos con tu caso específico</p>
